                    ...
                    <div class="day">
                        ...
                        <div class="postTitle">
                            <a class="postTitle2 vertical-middle" href="">
                                <span>用户Id:${user.uid}<br/>用户名:${user.username}<br/>手机号:${user.phone}<br/>密码:${user.password}<br/>注册时间:${user.register_time}</span>
                                <form action="/deleteUser" method="post">
                                    <input type="hidden" name="uid" value="${user.uid}">
                                    <button type="submit" name="id" >删除用户</button>
                                </form>
                                <%--<form action="/rename" method="post">
                                    <input type="hidden" name="id" value="user.uid">
                                    <button type="submit" name="id" >重命名</button>
                                </form>
                                <form action="/updatePassword" method="post">
                                    <input type="hidden" name="id" value="user.uid">
                                    <button type="submit" name="id" >修改密码</button>
                                </form>--%>
                            </a>
                        </div>
                        <div class="postCon">
                            <div class="c_b_p_desc"></div>
                        </div>
                        <div class="clear"></div>
                        <div class="postDesc">
