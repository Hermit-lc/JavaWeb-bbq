...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" action="/doPost">
            <!---隐藏的用户名-->
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <input type="text" class="form-control" id="title" placeholder="请输入标题" name="title" onblur ="CheckTitle();">
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-12">
                    <textarea class="form-control" rows="3" placeholder="请输入内容"  id="content" name="message" onblur="CheckMessage();"></textarea>
