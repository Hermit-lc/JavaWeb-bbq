...
<div id="home">
    <div id="header">
        <div id="blogTitle">
            ...
            <!--done-->
            <h1><a id="Header1_HeaderTitle" class="headermaintitle HeaderMainTitle" href="">游客</a>
            </h1>
            <h2></h2>
        ...
        <div id="navigator">
            ...
            <ul id="navList">
                <li><a id="blog_nav_sitehome" class="menu" href="http://localhost:8080/guestIndex">首页</a></li>
                <li><a id="blog_nav_myhome" class="menu" href="http://localhost:8080/guestHotIndex">热门</a></li>
                <li><a id="blog_nav_newpost" class="menu" href="http://localhost:8080/guestAffiche">公告</a></li>
                <li><a id="blog_nav_contact" class="menu" href="http://localhost:8080/userLogin">登录</a></li>
                <li><a id="blog_nav_admin" class="menu" href=""></a></li>
            </ul>
            <div class="blogStats">
    ...
    <div id="main">
        <div id="mainContent">
            <div class="forFlow">
                ...
                <c:forEach items="${guestHotList}" var="hot">
                    <div class="day">
                        <div class="dayTitle">
                        </div>
                        <div class="postTitle">
                        ...
                        <div class="postCon">
                            <div class="c_b_p_desc">${hot.message}</div>
                        </div>
                        <div class="clear"></div>
                        <div class="postDesc">posted @${hot.insert_time}点赞数:${hot.likes}</div>
                        <div class="clear"></div>
                    </div>
