    ...
    <div id="main">
        <div id="mainContent">
            <div class="forFlow">
                ...
                <c:forEach items="${adminHotList}" var="hot">
                    <div class="day">
                        <div class="dayTitle">
                        </div>
                        <div class="postTitle">
                            <a class="postTitle2 vertical-middle" href="">
                                <span>${hot.username}:${hot.title}</span>
                            </a>
                        </div>
                        <div class="postCon">
                            <div class="c_b_p_desc">${hot.message}
                            <form action="/adminHotShantie">
                                <input type="hidden" name="id" value="${hot.id}"/>
                                <button type="submit">删帖</button>
                            </form>
                            <form action="/adminHotDianzan">
                                <input type="hidden" name="id" value="${hot.id}"/>
                        ...
                        <div class="clear"></div>
                        <div class="postDesc">
                            posted @${hot.insert_time}点赞数:${hot.likes}
                        </div>
                        <div class="clear">
