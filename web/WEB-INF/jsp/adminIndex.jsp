...
<div id="top_nav" class="navbar forpc">
    <nav id="nav_main" class="navbar-main">
        <ul id="nav_left" class="navbar-list navbar-left"><li class="navbar-branding"><img src="/assets/img/biaobaiqiang_logo.png" width="80px" height="40px" alt="表白墙Logo" /></li></ul>
...
<div id="home">
    <div id="header">
        ...
        <div id="navigator">
            ...
            <ul id="navList">
                <li><a id="blog_nav_sitehome" class="menu" href="http://localhost:8080/adminIndex">首页</a></li>
                <li><a id="blog_nav_myhome" class="menu" href="http://localhost:8080/adminHot">热门</a></li>
                <li><a id="blog_nav_newpost" class="menu" href="http://localhost:8080/adminAffiche">公告</a></li>
                <li><a id="blog_nav_contact" class="menu" href="http://localhost:8080/adminPost">发公告</a></li>
                <li><a id="blog_nav_rss" class="menu" href="http://localhost:8080/adminManageUser">管理用户</a><li>
    ...
    <div id="main">
        <div id="mainContent">
            <div class="forFlow">
                ...
                <c:forEach items="${adminNoteList}" var="note">
                    <div class="day">
                        <div class="dayTitle">
                        </div>
                        <div class="postTitle">
                        ...
                        <div class="postCon">
                            <div class="c_b_p_desc">
                                    ${note.message}
                                <form action="/adminIndexShantie" method="post">
                                    <input type="hidden" name="id" value="${note.id}"/>
                                    <button type="submit" >删帖</button>
                                </form>
                                <%--<form action="/adminComment" method="post">
                                    <input type="hidden" name="id" value="${note.id}"/>
                                    <button type="submit">评论</button>
                                 </form>--%>
                                <form action="/adminIndexDianzan" method="post">
                                    <input type="hidden" name="id" value="${note.id}"/>
                        ...
                        <div class="clear">
                            <%--<c:forEach items="${adminCommentList}" var="com">
                                &lt;%&ndash;查询对应评论&ndash;%&gt;
                                ${com.username}:${com.message}--${com.insert_time}--${com.likes}<br/>
                            </c:forEach>--%>
                        </div>
                        <div class="postDesc">
