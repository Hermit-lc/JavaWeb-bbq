...
<div id="home">
  <div id="header">
    <div id="blogTitle">
      ...
      <!--done-->
      <h1><a id="Header1_HeaderTitle" class="headermaintitle HeaderMainTitle" href="">欢迎来到表白墙</a>
      </h1>
      <h2></h2>
    ...
    <div id="navigator">
      ...
      <ul id="navList">
        <li><a id="blog_nav_sitehome" class="menu" href="http://localhost:8080/guestIndex">游客进入</a></li>

        <li><a id="blog_nav_myhome" class="menu" href="">  </a></li>

        <li><a id="blog_nav_newpost" class="menu" href="">  </a></li>
    ...
    <div id="mainContent">
      <div class="forFlow">
        ...
        <div class="day">
          ...
          <div class="postCon">
            <div class="c_b_p_desc">向世界分享你的知识、经验和见解。</div>
          </div>
          <div class="clear"></div>
          <div class="postDesc">posted @2021-6-24</div>
          <div class="clear"></div>
        </div>
          ...
          <div class="day">
              ...
              <div class="postCon">
                  <div class="c_b_p_desc">发帖不含政治、广告、诽谤、歧视等内容。</div>
              </div>
              <div class="clear"></div>
              <div class="postDesc">posted @2021-6-24</div>
              <div class="clear"></div>
